...
<body>
    ...
    <table>
        <tr>
            <td class="label">Вартість послуг з українським підрядником</td>
            <td class="value">${escapeHtml(data.cost.costUkr)}</td>
        </tr>
        ...
        <tr>
            <td class="label">Вартість послуг з іноземним підрядником</td>
            <td class="value">${escapeHtml(data.cost.foreignCost)}</td>
        </tr>

        <tr>
            <td class="label">Валюта іноземного підрядника</td>
    ...
    <h2>11. Файли та посилання</h2>

    <table>
        <tr>
            <td class="label">Наявні документи</td>
